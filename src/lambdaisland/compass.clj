...
(require
 ...
 'lambdaisland.compass.http
 'lambdaisland.compass.css
 )
...
(def system-edn (io/resource "compass/system.edn"))
...
(defn set-prep!
  ...
  ([profile]
   ...
   (lambdaisland.compass.css/spit-styles)))
...
(defn -main [& command-line-args]
  (cli/dispatch*
   {:name       "clojure -M -m lambdaisland.compass"
    :flags      flags
    :commands   commands}
   command-line-args))
