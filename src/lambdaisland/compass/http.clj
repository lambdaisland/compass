(ns lambdaisland.compass.http
  "System-level component: web server

  The config of http is in the file
  'resources/lambdaisland/compass/system.edn'
  ...
  (:require
   ...
   [lambdaisland.compass.http.middleware :as middleware]
   [lambdaisland.compass.http.routes :as routes]
